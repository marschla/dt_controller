...
class ControllerNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        # construct publisher
        self.pub_wheels_cmd = rospy.Publisher(str(os.environ['VEHICLE_NAME'])+"/wheels_driver_node/wheels_cmd", WheelsCmdStamped, queue_size=1,dt_topic_type=TopicType.CONTROL)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            phiref, vref = self.getphiref(self.dist)
